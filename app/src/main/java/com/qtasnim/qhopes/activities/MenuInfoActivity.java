...
import com.qtasnim.qhopes.adapters.InfoAdapter;
...
public class MenuInfoActivity extends AppCompatActivity {
    ...
    private ArrayList<InfoModel> mModelData = new ArrayList<>();
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            // viewHolder.itemView;
            InfoModel mInfoModel = mModelData.get(position);
            setDialog(mInfoModel);

        }
    };

    private void setDialog(InfoModel currentModel) {

        final Dialog mDialog = new Dialog(MenuInfoActivity.this);
...
//    }
    ...
    private void setActionBar() {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(getString(R.string.tbtn_menu_info));
...
//                transaction.commit();
    ...
    private void initData() {
        mModelData.add(new InfoModel("Pelatihan Pemadaman Kebakaran","15/05/2019","foto_berita","RS. Bhakti Husada Cikarang melakukan pelatihan pemadam kebakaran terhadap semua staff dan karyawan yang dilaksanakn setiap tahun dan bekerja sama dengan tim pemadam kebakaran Kab. Bekasi"));
        mModelData.add(new InfoModel("ISPA","10/10/17","foto_berita2","ISPA adalah kepanjanngan dari Infeksi Saluran Pernafasan Akut yang berarti terjadinya infeksi yang parah pada bagian sinus, tenggorokan, saluran udara, atau paru-paru. Kondisi ini menyebabkan fungsi pernafasan menjadi terganggu. Jika tidak segera ditangani, ISPA dapat menyebar ke seluruh sistem pernafasan tubuh bahkan dapat menyebabkan kematian."));
        InfoAdapter mAdapter = new InfoAdapter(mModelData);
